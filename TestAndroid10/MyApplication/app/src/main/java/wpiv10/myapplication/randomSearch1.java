...
public class randomSearch1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new SearchAdapter(randomSearch1.this,  cursor, 0);
    ...
    private void insertDummy(){
        cursor=DBOperator.getInstance().execQuery(SQLCommand.QUERY_12);
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            search.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextSubmit(String s) {
                    ...
                    cursor=DBOperator.getInstance().execQuery(SQLCommand.QUERY_13, new String[]{s});
                    SimpleCursorAdapter adapter = new SimpleCursorAdapter(getApplicationContext(), R.layout.club_searchin,
                            cursor, new String[]{"_id", "club_name"},
                            new int[]{R.id.clubidrs, R.id.clubNamers},
                            SimpleCursorAdapter.IGNORE_ITEM_VIEW_TYPE);
                    ...
                    if (cursor==null){
                        Toast.makeText(randomSearch1.this,"No records found!",Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(randomSearch1.this, cursor.getCount() + " records found!",Toast.LENGTH_LONG).show();
                    }
                    customAdapter.swapCursor(cursor);
