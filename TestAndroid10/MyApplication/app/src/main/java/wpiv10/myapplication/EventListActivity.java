...
public class EventListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_list_test);

        evtListView = (ListView)findViewById(R.id.checkout_listview);
        evtListView.setOnItemClickListener(new ItemClickListener());
        //customAdapter = new SearchAdapter(EventListActivity.this, cursor, 0);

        String sql = SQLCommand.CHECKOUT_LIST_Club;
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                ...
                new int[]{R.id.event_id, R.id.event_name, R.id.event_date, R.id.event_time, R.id.event_location},
    ...
    class ItemClickListener implements AdapterView.OnItemClickListener {
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            while(i <= position){
                if (position == i) {
                    Intent intent = new Intent(EventListActivity.this, chessEventPage.class);
